class Brand extends Phaser.Scene {
...
preload() {
    ...
    this.load.image('formA1_img', 'assets/Brand/Form1_Brand.png');
    this.load.image('formA2_img', 'assets/Brand/Form2_Brand.png');
    this.load.image('formA3_img', 'assets/Brand/Form3_Brand.png');
    this.load.image('formA4_img', 'assets/Brand/Form4_Brand.png');
...
create() {
    ...
    this.physics.add.collider(this.formulário_1, lixo);
    this.physics.add.collider(this.formulário_2, lixo);
    this.physics.add.collider(this.formulário_3, lixo);
    this.physics.add.collider(this.formulário_4, lixo);

    // Adicionando a Física ao Aprovado
    this.physics.add.collider(this.formulário_1, aprovado);
    this.physics.add.collider(this.formulário_2, aprovado);
    this.physics.add.collider(this.formulário_3, aprovado);
    this.physics.add.collider(this.formulário_4, aprovado);
